<template>
    <div class="min-h-screen flex items-start justify-center pt-20">
      <div
        class="max-w-lg bg-white bg-opacity-80 backdrop-blur-md rounded-lg shadow-lg p-8 transform transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl glow-effect"
      >
